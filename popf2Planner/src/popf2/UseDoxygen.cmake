...
#
#  DOXYFILE_TARGET_SUFFIX - Suffix for the target name used
#
...
if(DOXYGEN_FOUND AND DOXYFILE_IN_FOUND)
	add_custom_target(doxygen${DOXYFILE_TARGET_SUFFIX} ${DOXYGEN_EXECUTABLE} ${CMAKE_CURRENT_BINARY_DIR}/Doxyfile)
	...
	add_dependencies(doc doxygen${DOXYFILE_TARGET_SUFFIX})
endif()
